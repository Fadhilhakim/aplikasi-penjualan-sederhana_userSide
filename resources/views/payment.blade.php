<x-layout>
    ...
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16 h-full">
                ...
                <section class="p-2 max-w-5xl mx-auto">
                    ...
                    <div class="mx-auto max-w-5xl">
                        ...
                        @if (@$order_request['status'] == 'BELUM BAYAR')
                            ...
                            @elseif (@$order_request['status'] == 'MENUNGGU KONFIRMASI')
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Proses Pengiriman.. Menunggu Konfirmasi</h2>
                            @else 
                                ...
                                <div class="space-y-2">
                                    ...
                                    @if ($order_request['status'] == 'MENUNGGU KONFIRMASI')
                                        ...
                                        onsubmit="return confirm('Pastikan anda telah menerima pesanan!');">
                                            @csrf
                                            <button type="submit" class="bg-indigo-700 p-2 px-7 text-center text-xl font-extrabold text-gray-200 hover:bg-indigo-900 hover:underline">BARANG DITERIMA</button>
                                        </form>
                                    @endif
        ...
        @else 
            ...
            <h2 class="text-3xl text-center font-semibold text-gray-900 dark:text-white sm:text-2xl">Anda belum punya pesanan );</h2>
            <h2 class="text-xl text-center font-semibold text-gray-900 dark:text-gray-300 sm:text-2xl"><a href="/">Silahkan cari produk terlebih dahulu</a></h2>
